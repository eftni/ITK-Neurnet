...
int main()
{
    ...
    cl::Buffer next_delta_buffer = cl::Buffer(delta_kernel.get_context(), CL_MEM_READ_WRITE, sizeof(float)*output.size());
    ...
    cl::Buffer dummy = cl::Buffer(delta_kernel.get_context(), CL_MEM_READ_ONLY, 0);
    delta_kernel(cl::NullRange, cl::NDRange(3), cl::NullRange, 0, input_buffer, output_buffer, w_buffer, 3, target_buffer, 0, dummy, delta_buffer);
